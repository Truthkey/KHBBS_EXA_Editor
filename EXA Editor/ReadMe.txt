========================================================================
    APLICACIÓN: Información general del proyecto EXA Editor
========================================================================

AppWizard ha creado esta aplicación EXA Editor.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación EXA Editor.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado EXA Editor.pch y un archivo de 
